  ...
  return (
    <article>
      ...
      <section>
        ...
        <ul>
          <li>Use a higher-level connected component. Storybook helps you compose such data from the - of child component stories + &ldquo;args&ldquo; of child component stories</li>
